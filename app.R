...
net_measurements <- read.csv(file = "csv/collectl_network.csv", na="NA", skip=0)
net_measurements$Time
...
cpu_usage_plot <- drawPlot("CPU-Verbrauch", "CPU utilization (%)", cpeeeu_usage / 1000, time_in_seconds)
